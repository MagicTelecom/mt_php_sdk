...
class DidsProductsController {
     ...
     * @param  string     $filter     Required parameter: Allowed fields: country_iso2, region_handle, location_handle, location_name, phone_number, phone_number_type, zip_code
     ...
     * @param  int        $page        Required parameter: Zero based offset index for the results. e.g. 0 would start at the first result and 10 would start at the eleventh result
     * @param  int        $limit       Required parameter: Maximum number of results to return in the response
     * @param  string     $filter      Required parameter: Allowed fields: country_iso2, region_handle, location_handle, location_name, prefix, phone_number_type, zip_code, npa, nxx, fax
     * @return mixed response from the API call*/
